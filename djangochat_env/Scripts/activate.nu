...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\pinkr\PycharmProjects\pythonProject\Private chat\djangochat_env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\pinkr\PycharmProjects\pythonProject\Private chat\djangochat_env\Scripts\deactivate.nu'
